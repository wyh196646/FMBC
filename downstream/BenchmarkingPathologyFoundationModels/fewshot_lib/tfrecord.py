...
from fewshot_lib import example_pb2
...
def tfrecord_iterator(data_path: str,
    ...
    """Create an iterator over the tfrecord data_lib.
    ...
    shard: tuple of ints, optional, default=None
        ...
        count. Necessary to evenly split/shard the data_lib among many
        workers (i.e. >1).
...
def example_loader(data_path: str,
    ...
    Decodes raw bytes of the features (contained within the data_lib)
...
def sequence_loader(data_path: str,
    ...
    data_lib) into its respective format.
...
class TFRecordDataset(torch.utils.data.IterableDataset):
    """Parse (generic) TFRecords data_lib into `IterableDataset` object,
