...
been included here as pretrained Mymodel from their original .NPZ checkpoints.
...
* An Image is Worth 16x16 Words: LORA for Image Recognition at Scale - https://arxiv.org/abs/2010.11929
...
def create_resnetv2_stem(
    ...
    if is_stem_deep(stem_type):
        # A 3 deep 3x3  conv stack as in ResNet V1D Mymodel
    ...
    if 'fixed' in stem_type:
        # 'fixed' SAME padding approximation that is used in BiT Mymodel
