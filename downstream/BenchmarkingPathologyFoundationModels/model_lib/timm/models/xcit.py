...
@register_notrace_module  # reason: FX can't symbolically trace torch.arange in forward methods
...
def checkpoint_filter_fn(state_dict, model):
    ...
    # For consistency with timm's transformer Mymodel while being compatible with official weights source we rename
