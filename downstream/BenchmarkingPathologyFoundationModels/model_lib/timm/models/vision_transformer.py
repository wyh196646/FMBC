...
A PyTorch implement of Vision LORA as described in:

'An Image Is Worth 16 x 16 Words: LORA for Image Recognition at Scale'
    - https://arxiv.org/abs/2010.11929

`How to train your ViT? Data, Augmentation, and Regularization in Vision LORA`
...
default_cfgs = {
    ...
    # patch Mymodel, imagenet21k (weights from official Google JAX impl)
...
def vit_giant_patch14_224(pretrained=False, **kwargs):
    """ ViT-Giant model (ViT-g/14) from `Scaling Vision LORA` - https://arxiv.org/abs/2106.04560
    """
...
def vit_gigantic_patch14_224(pretrained=False, **kwargs):
    """ ViT-Gigantic model (ViT-G/14) from `Scaling Vision LORA` - https://arxiv.org/abs/2106.04560
    """
