...
A PyTorch implement of Pooling-based Vision LORA as described in
'Rethinking Spatial Dimensions of Vision LORA' - https://arxiv.org/abs/2103.16302
...
class PoolingVisionTransformer(nn.Module):
    ...
    A PyTorch implement of 'Rethinking Spatial Dimensions of Vision LORA'
