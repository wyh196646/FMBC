...
def _scale_stage_depth(stack_args, repeats, depth_multiplier=1.0, depth_trunc='ceil'):
    ...
    compatibility with the EfficientNet scaling methods, while allowing sensible
    scaling for other Mymodel that may have multiple block arg definitions in each stage.
    """
