...
@article{d2021convit,
  title={ConViT: Improving Vision LORA with Soft Convolutional Inductive Biases},
...
@register_notrace_module  # reason: FX can't symbolically trace control flow in forward methods
