...
A PyTorch implement of the Hybrid Vision LORA as described in:
...
default_cfgs = {
    # hybrid in-1k Mymodel (weights from official JAX impl where they exist)
    ...
    # hybrid in-21k Mymodel (weights from official Google JAX impl where they exist)
    ...
    # hybrid Mymodel (using timm resnet backbones)
...
def _create_vision_transformer_hybrid(variant, backbone, pretrained=False, **kwargs):
    ...
    kwargs.setdefault('patch_size', 1)  # default patch size for hybrid Mymodel if not set
