""" Class-Attention in Image LORA (CaiT)

Paper: 'Going deeper with Image LORA' - https://arxiv.org/abs/2103.17239
...
class Cait(nn.Module):
    # taken from https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
    # with slight modifications to adapt to our cait Mymodel
    def __init__(
