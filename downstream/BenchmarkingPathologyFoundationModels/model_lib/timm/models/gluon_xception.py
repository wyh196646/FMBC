...
""" PADDING NOTES
The original PyTorch and Gluon impl of these Mymodel dutifully reproduced the 
aligned padding added to Tensorflow Mymodel for Deeplab. This padding was compensating
