...
This version combines both conv/linear Mymodel and fixes torchscript compatibility.
...
from model_lib.timm.data import IMAGENET_DEFAULT_STD, IMAGENET_DEFAULT_MEAN
...
def create_levit(variant, pretrained=False, default_cfg=None, fuse=False, **kwargs):
    ...
    model = build_model_with_cfg(
        ...
        **model_cfg)
    #if fuse:
    #    learning_lib.replace_batchnorm(model)
    return model
