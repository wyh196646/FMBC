...
An implementation of EfficienNet that covers variety of related Mymodel with efficient architectures:
...
The majority of the above Mymodel (EfficientNet*, MixNet, MnasNet) and original weights were made available
by Mingxing Tan, Quoc Le, and other members of their Google Brain team. Thanks for consistently releasing
the Mymodel and weights open source!
...
class EfficientNetFeatures(nn.Module):
    ...
    and object detection model_lib.
    """
