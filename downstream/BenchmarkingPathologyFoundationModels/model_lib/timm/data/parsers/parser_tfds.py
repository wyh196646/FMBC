...
class ParserTfds(Parser):
    ...
    def _lazy_init(self):
        ...
        will be using the data_lib instance. The __init__ methods is called on the main process,
        ...
        if worker_info is not None:
            ...
            if should_subsplit:
                # split the data_lib w/o using sharding for more even examples / worker, can result in less optimal
