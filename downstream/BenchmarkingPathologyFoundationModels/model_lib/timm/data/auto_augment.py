...
def _posterize_increasing_level_to_arg(level, hparams):
    # As per Tensorflow model_lib research and UDA impl
...
def auto_augment_transform(config_str, hparams):
    ...
    for c in config:
        ...
        if key == 'mstd':
            ...
            assert False, 'Unknown AutoAugment config.py section'
...
def rand_augment_transform(config_str, hparams):
    ...
    for c in config:
        ...
        if key == 'mstd':
            ...
            assert False, 'Unknown RandAugment config.py section'
...
def augment_and_mix_transform(config_str, hparams):
    ...
    for c in config:
        ...
        if key == 'mstd':
            ...
            assert False, 'Unknown AugMix config.py section'
