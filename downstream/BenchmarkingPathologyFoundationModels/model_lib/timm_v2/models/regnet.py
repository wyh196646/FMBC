...
from model_lib.timm_v2.layers import ClassifierHead, AvgPool2dSame, ConvNormAct, SEModule, DropPath, GroupNormAct
from model_lib.timm_v2.layers import get_act_layer, get_norm_act_layer, create_conv2d, make_divisible
...
def regnetz_005(pretrained=False, **kwargs) -> RegNet:
    """RegNetZ-500MF
    NOTE: config.py found in https://github.com/facebookresearch/ClassyVision/blob/main/classy_vision/models/regnet.py
