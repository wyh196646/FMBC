...
"""
Modifed from model_lib.timm_v2. https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
from model_lib.timm_v2.layers import DropPath, to_2tuple, trunc_normal_, _assert
