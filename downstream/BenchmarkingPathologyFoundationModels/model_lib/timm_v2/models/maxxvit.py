...
from model_lib.timm_v2.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from model_lib.timm_v2.layers import Mlp, ConvMlp, DropPath, LayerNorm, ClassifierHead, NormMlpClassifierHead
from model_lib.timm_v2.layers import create_attn, get_act_layer, get_norm_layer, get_norm_act_layer, create_conv2d, create_pool2d
from model_lib.timm_v2.layers import trunc_normal_tf_, to_2tuple, extend_tuple, make_divisible, _assert
from model_lib.timm_v2.layers import RelPosMlp, RelPosBias, RelPosBiasTf, use_fused_attn, resize_rel_pos_bias_table
...
class MaxxVitConvCfg:
    ...
    def __post_init__(self):
        # mbconv vs convnext blocks have different defaults, set in post_init to avoid explicit config.py args
