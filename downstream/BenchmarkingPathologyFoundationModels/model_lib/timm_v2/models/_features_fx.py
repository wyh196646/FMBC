...
from model_lib.timm_v2.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from model_lib.timm_v2.layers.non_local_attn import BilinearAttnTransform
from model_lib.timm_v2.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
from model_lib.timm_v2.layers.norm_act import (
    BatchNormAct2d,
    SyncBatchNormAct,
...
# NOTE: By default, any modules from model_lib.timm_v2.models.layers that we want to treat as leaf modules go here
# BUT modules from model_lib.timm_v2.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from model_lib.timm_v2.layers import InplaceAbn
