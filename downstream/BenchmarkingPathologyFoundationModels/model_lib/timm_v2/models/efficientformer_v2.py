...
from model_lib.timm_v2.layers import create_conv2d, create_norm_layer, get_act_layer, get_norm_layer, ConvNormAct
from model_lib.timm_v2.layers import DropPath, trunc_normal_, to_2tuple, to_ntuple, ndgrid
...
class EfficientFormerV2(nn.Module):
    ...
    def forward_head(self, x, pre_logits: bool = False):
        ...
        if self.distilled_training and self.training and not torch.jit.is_scripting():
            ...
            # during standard train/data_lib, inference average the classifier predictions
            return (x + x_dist) / 2
