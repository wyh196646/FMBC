...
from model_lib.timm_v2.data import IMAGENET_INCEPTION_MEAN, IMAGENET_INCEPTION_STD
from model_lib.timm_v2.layers import PatchEmbed, Mlp, DropPath, RelPosMlp, RelPosBias, use_fused_attn, LayerType
...
def vit_relpos_base_patch16_clsgap_224(pretrained=False, **kwargs) -> VisionTransformerRelPos:
    """ ViT-Base (ViT-B/16) w/ relative log-coord position, class token present
    NOTE this config.py is a bit of a mistake, class token was enabled but global avg-pool w/ fc-norm was not disabled
