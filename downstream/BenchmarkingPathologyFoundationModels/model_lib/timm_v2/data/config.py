...
def resolve_data_config(
    ...
    assert model or args or pretrained_cfg, "At least one of model, args, or pretrained_cfg required for data config.py."
    args = args or {}
    ...
    # resolve data_lib + model mean for normalization
    ...
    # resolve data_lib + model std deviation for normalization
    ...
    if verbose:
        _logger.info('Data processing configuration for current model + data_lib:')
