...
from model_lib.timm_v2.data.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, DEFAULT_CROP_PCT
from model_lib.timm_v2.data.auto_augment import rand_augment_transform, augment_and_mix_transform, auto_augment_transform
from model_lib.timm_v2.data.transforms import str_to_interp_mode, str_to_pil_interp, RandomResizedCropAndInterpolation,\
    ResizeKeepRatio, CenterCropOrPad, RandomCropOrPad, TrimBorder, ToNumpy
from model_lib.timm_v2.data.random_erasing import RandomErasing
...
def transforms_imagenet_train(
    ...
    Returns:
        ...
        for use in a mixing data_lib that passes
...
def create_transform(
    ...
    if tf_preprocessing and use_prefetcher:
        ...
        from model_lib.timm_v2.data.tf_preprocessing import TfPreprocessTransform
