""" A data_lib reader that reads single tarfile based datasets
...
from model_lib.timm_v2.utils.misc import natural_key
...
class ReaderImageTar(Reader):
    """ Single tarfile data_lib where classes are mapped to folders within tar
