...
def main():
    ...
    parser.add_argument('--hyperparams_yaml', type=str, default = '../hyperparam_sweep/configs', help='Root directory for the hyperparameter config files')
    parser.add_argument('--pooled_dirs_root', type=str, default = '../artifacts/pooled_features', help='Root directory for saving pooled embeddings. Not needed for finetuining.')
    parser.add_argument('--splits_root', type=str, default = '../artifacts/splits', help='Root directory for saving splits')
