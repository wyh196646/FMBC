...
experiment = ExperimentFactory.linprobe( # This is linear probing, but similar APIs are available for coxnet, protonet, retrieval, and finetune
                    ...
                    task_name = task_name,
                    patch_embeddings_dirs = '/data4/embedding/BRACS/FMBC', # Can be list of paths if patch features are split across multiple directories. See NOTE below.
