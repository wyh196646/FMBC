...
class VITRMIM(VisionTransformer):
    def __init__(self, num_classes=0, embed_dim=384, depth=12,
                 num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop_rate=0., attn_drop_rate=0.,
                 drop_path_rate=0.,norm_layer=nn.LayerNorm,slide_ngrids=1000,cross_reconstruct=False,pos_embed=False, **kwargs):
        ...
        self.pos_embd= pos_embed
        self.cross_reconstruct = cross_reconstruct
        ...
        self.decoder=nn.TransformerEncoderLayer(self.embed_dim, nhead=2,
                dim_feedforward=self.embed_dim, activation="relu")
