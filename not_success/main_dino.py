...
def get_args_parser():
    ...
    parser.add_argument('--mlm_ratio', default=0, type=float, help="""Ratio of Masking language Model ratio""")
    ...
    parser.add_argument('--cross_reconstruct',default=False, type=utils.bool_flag, help="""Whether or not to use cross reconstruct""")
    ...
    parser.add_argument("--pos_embed",default=False, type=bool, help="if add postion embed")
    return parser
...
def train_dino(args):
    ...
    if args.arch in vits.__dict__.keys():
        student = vits.__dict__[args.arch](
            ...
            cross_reconstruct=args.cross_reconstruct,
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    for it, (teacher_feat,teacher_coords,teacher_mask,teacher_mlm,student_feat,
        ...
        with torch.cuda.amp.autocast(fp16_scaler is not None):#image[0].shape [64, 3, 224, 224] , image[1].shape [64, 3, 96, 96]
            ...
            loss= dino_loss(student_output, teacher_output, epoch)+mlm_loss + crsc_loss
        ...
        metric_logger.update(crsc_loss=crsc_loss)
        metric_logger.update(mlm_loss=mlm_loss)
        #metric_logger.update(dio_loss=dino_loss.item())
