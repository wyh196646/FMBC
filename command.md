...
```
CUDA_VISIBLE_DEVICES=3 python main.py --task_cfg_path task_configs/mutation_5_gene.yaml --dataset_csv dataset_csv/mutation/LUAD-5-gene_TCGA.csv --root_path /home/yuhaowang/data/test/TCGA-LUAD --blr 0.002 --layer_decay 0.95 --optim_wd 0.05 --dropout 0.1 \
