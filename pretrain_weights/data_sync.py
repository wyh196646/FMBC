...
#     try:
#         compare_and_sync(ssh, remote_dir, local_dir)
#     finally:
#         ssh.close()
#     # try:
#     #     for dir in data_dir:
...
#python data_sync.py --host 172.16.120.24 --password 4090@YHWang --remote_dir /home/yuhaowang/project/FMBC/finetune/outputs --local /ruiyan/yuhao/project/FMBC/finetune/outputs

#python data_sync.py --username root --host 172.16.120.7 --port 30523 --password bupt123BUPT@ --remote_dir /yuhaowang/project/FMBC/finetune/outputs --local /ruiyan/yuhao/project/FMBC/finetune/outputs