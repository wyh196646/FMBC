...
class TileDataset(ExtendedVisionDataset):
    def __init__(self,
        ...
        #subfolder_list=['private_chunk_1','private_chunk_2']
        #subfolder_list=['private_chunk_3','private_chunk_5']
        #subfolder_list=['private_chunk_6','private_chunk_7']
        #subfolder_list=['private_chunk_9','private_chunk_10']
        subfolder_list=['private_chunk_1','private_chunk_2','private_chunk_3','private_chunk_4','private_chunk_5','private_chunk_6','private_chunk_7','private_chunk_8','private_chunk_9','private_chunk_10']
        #subfolder_list=['private_chunk_test']
