...
sys.path.append('/yuhaowang/project/dinov2')
...
from torch import nn
import sys
sys.path.append('/ruiyan/yuhao/project/dinov2')
...
# python dinov2/run/eval/feature_extractor.py  --config-file dinov2/configs/train/patch.yaml --pretrained-weights /ruiyan/yuhao/project/dinov2/output/eval/training_62499/teacher_checkpoint.pth --output-dir /ruiyan/yuhao/data/embedding --train-dataset TileDataset:split=TRAIN:root=/ruiyan/yuhao/data \ 
