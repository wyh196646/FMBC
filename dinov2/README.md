...
```
Runing with private data


torchrun --nproc_per_node=1 dinov2/run/train/train.py     --config-file dinov2/configs/train/vitl16_short.yaml --output-dir ./output/     train.dataset_path=TileDataset:split=TRAIN:root=/yuhaowang/data/private_chunk_4/output:extra=//yuhaowang/data/private_chunk_4/output
```